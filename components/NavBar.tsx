...
const NavBar: React.FC<NavBarProps> = ({}) => {
  ...
  return (
    <div className="fixed w-full flex h-[44px]  bg-black justify-between items-center p-2">
      ...
      <div className="flex gap-4 items-center">
        <SearchBar />
        <BsFillChatRightFill size={12} className="focus:opacity-80 hover:opacity-80 transition mx-2 mt-1"/>
